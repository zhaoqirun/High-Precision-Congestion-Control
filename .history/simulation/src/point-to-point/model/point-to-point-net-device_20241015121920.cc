...
PointToPointNetDevice::PppToEther (uint16_t proto)
{
  switch(proto)
    ...
    // case 0x0021: return 0x0800;：如果 proto 是 0x0021（PPP for IPv4），则返回 0x0800（以太网协议号 for IPv4）。
    // case 0x0057: return 0x86DD;：如果 proto 是 0x0057（PPP for IPv6），则返回 0x86DD（以太网协议号 for IPv6）
  return 0;
}
